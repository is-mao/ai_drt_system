...
class Config:
    ...
    DEFECT_VALUES = [
        'CABLE_LOOSE', 'CHASSIS_FAILURE', 'COULD_NOT_CLASSIFY', 'EEPROM_MISPRGRMD',
        'EQUIPMENT_PROBLEM', 'FIXTURE_PROBLEM', 'Hardware', 'INCORRECT_OPERATOR_RESPONSE',
        'MISASSEMBLED', 'MISSED_SCAN', 'NETWORK', 'NO_BOOT', 'OP_EJECTOR_CHECK',
        'OPERATOR_PROCESS', 'ORDER', 'PCBA_FAILRE', 'PCBA_FAILURE', 'SCRIPT_PROBLEM',
        'TEST_CABLE_NOT_CONNECTED', 'TEST_DEBUG', 'TEST_SCRIPTS', 'TEST_SETUP_ISSUE',
    ]
